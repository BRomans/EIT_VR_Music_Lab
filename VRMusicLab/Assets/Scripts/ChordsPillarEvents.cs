...
public class ChordsPillarEvents : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerDownHandler, IPointerUpHandler, IPointerClickHandler
{
    ...
    [SerializeField] AudioClip[] keySources;
